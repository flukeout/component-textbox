...
Appmaker import:
```
<link rel="import" href="/component-textbox">
```

# Test Status

See the github page http://mozilla-appmaker.github.io/component-textbox/ for test status.
...
Clone this repo:
```
git clone git@github.com:mozilla-appmaker/component-textbox.git
```
...
Your directory structure should look like this (more component repos can be cloned as siblings of `component-textbox`):
```
mozilla-appmaker/
  ├── appmaker/
  ├── component-textbox/
...
Enter the `component-textbox` directory, and install npm dependencies
```
cd component-textbox
npm install
```
